...
for i in {000..012} {014..067} {069..094} {096..120} 122 124 {126..131} 138 {190..200}; do
...
for i in {000..012} {014..067} {069..094} {096..120} 122 124 {126..131} 138 {190..200}; do
  (cd checked-out-ref/$i; git -c advice.detachedHead=false checkout `git rev-list -1 --date=iso --before="2024-04-29T17:10:00+00:00" master`)
done
